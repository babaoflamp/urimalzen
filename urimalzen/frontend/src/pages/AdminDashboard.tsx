  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.menuGrid}>
        ...
        <div style={styles.menuCard} onClick={() => alert('KIIP 콘텐츠 관리 기능 준비 중')}>
          <div style={styles.menuIcon}>🎓</div>
          <div style={styles.menuTitle}>KIIP 콘텐츠</div>
          <div style={styles.menuDescription}>단계별 학습 콘텐츠 관리</div>
        </div>

        <div style={styles.menuCard} onClick={() => alert('시스템 설정 기능 준비 중')}>
